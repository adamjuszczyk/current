...
- [x] **2b.2** Run `0002_v2.sql`, as verified fresh in 2a.1, against the live project.
  ...
  - **Acceptance, RLS half — outstanding.** `npm run verify:rls` across all eight tables against the live project still needs the anon key in a session that can run it.
